-redexport const config = {
	mapTitle: 'female-representation-parliament', // The title of the map, if more than one word, separate by dash, e.g. "income-europe"
	vercelURL: 'map-female-parliament-representation.vercel.app', // The url provided when deploying the map on Vercel
